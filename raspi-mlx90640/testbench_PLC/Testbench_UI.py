...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def wall_control(self):
        if (self.ui.CM_11XX.currentIndex() == i for i in control_mode):
            if self.ui.CM_11XX.currentIndex() != 10:
        ...
        if (self.ui.CM_10X1.currentIndex() == i for i in control_mode):
            if self.ui.CM_10X1.currentIndex() != 10:
        ...
        if (self.ui.CM_12XA.currentIndex() == i for i in control_mode):
            if self.ui.CM_12XA.currentIndex() != 10:
    ...
    def set_control_mode_floor(self):
        ...
        client.publish("Rkl/WtrSup/zone11/wall_10X1/eCtrlMode", control_mode_10X1, qos=0, retain=False)
    ...
    def set_supply_temp_frontwall(self):
        surface_temp_set_1110 = self.ui.STset_1110.value()
        surface_temp_set_1120 = self.ui.STset_1120.value()
        surface_temp_set_1130 = self.ui.STset_1130.value()
        surface_temp_set_1140 = self.ui.STset_1140.value()
        surface_temp_set_1150 = self.ui.STset_1150.value()
        surface_temp_set_1160 = self.ui.STset_1160.value()
        client.publish("Rkl/WtrSup/zone11/panel_4/fSurfTempSet", surface_temp_set_1110, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_5/fSurfTempSet", surface_temp_set_1120, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_6/fSurfTempSet", surface_temp_set_1130, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_7/fSurfTempSet", surface_temp_set_1140, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_8/fSurfTempSet", surface_temp_set_1150, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_9/fSurfTempSet", surface_temp_set_1160, qos=0, retain=False)

    def set_supply_temp_sidewall(self):
        surface_temp_set_121A = self.ui.STset_121A.value()
        surface_temp_set_122A = self.ui.STset_122A.value()
        surface_temp_set_123A = self.ui.STset_123A.value()
        surface_temp_set_124A = self.ui.STset_124A.value()
        surface_temp_set_125A = self.ui.STset_125A.value()
        client.publish("Rkl/WtrSup/zone11/panel_10/fSurfTempSet", surface_temp_set_121A, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_11/fSurfTempSet", surface_temp_set_122A, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_12/fSurfTempSet", surface_temp_set_123A, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_13/fSurfTempSet", surface_temp_set_124A, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_14/fSurfTempSet", surface_temp_set_125A, qos=0, retain=False)

    def set_supply_temp_floor(self):
        surface_temp_set_10L1 = self.ui.STset_10L1.value()
        surface_temp_set_10S123 = self.ui.STset_10S123.value()
        surface_temp_set_10L2 = self.ui.STset_10L2.value()
        surface_temp_set_10L3 = self.ui.STset_10L3.value()
        client.publish("Rkl/WtrSup/zone11/panel_0/fSurfTempSet", surface_temp_set_10L1, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_1/fSurfTempSet", surface_temp_set_10S123, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_2/fSurfTempSet", surface_temp_set_10L2, qos=0, retain=False)
        client.publish("Rkl/WtrSup/zone11/panel_3/fSurfTempSet", surface_temp_set_10L3, qos=0, retain=False)
